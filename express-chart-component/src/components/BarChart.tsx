                ...
                return (
                    <div className='flex flex-col items-center relative' key={index}>
                        <div
                            ...
                            style={{ height }}
                        />
                        <div className='z-10 flex justify-center text-white bg-dark-brown items-center text-xs sm:text-lg text-center sm:p-2 px-2 py-1 sm:w-full w-[56px] h-10 rounded-lg absolute -top-12 origin-bottom invisible peer-hover:visible'>${day.amount}</div>
